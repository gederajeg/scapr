...
#'
#' @description This is a wrapper to put HTML-tag around character string input to be rendered as \strong{boldfaced} small capital in the output document of an R Markdown file.
