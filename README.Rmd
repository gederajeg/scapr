...
Another example is to include other markdown formattings, such as **boldface** (e.g., `` `r knitr::inline_expr('scapr::scaps("**happiness**")')` `` that results in `r scaps("**happiness**")`) and *italics* (e.g., `` `r knitr::inline_expr('scapr::scaps("*happiness*")')` `` that results in `r scaps("*happiness*")`).
